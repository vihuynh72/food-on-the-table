...
export const foodKnowledgeBase: FoodKnowledgeItem[] = [
  ...
  { name: "Carrots", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 21, icon: "🥕", defaultUnit: "bag" },
  ...
  { name: "Potatoes", category: "vegetable", defaultStorage: "pantry", shelfLifeDays: 30, icon: "🥔", defaultUnit: "bag" },
  { name: "Sweet Potato", category: "vegetable", defaultStorage: "pantry", shelfLifeDays: 30, icon: "🍠", defaultUnit: "pcs" },
  { name: "Onion", category: "vegetable", defaultStorage: "pantry", shelfLifeDays: 30, icon: "🧅", defaultUnit: "pcs" },
  { name: "Onions", category: "vegetable", defaultStorage: "pantry", shelfLifeDays: 30, icon: "🧅", defaultUnit: "bag" },
  { name: "Garlic", category: "vegetable", defaultStorage: "pantry", shelfLifeDays: 30, icon: "🧄", defaultUnit: "head" },
  ...
  { name: "Romaine", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 7, icon: "🥬", defaultUnit: "head" },
  { name: "Bell Pepper", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 7, icon: "🫑", defaultUnit: "pcs" },
  { name: "Bell Peppers", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 7, icon: "🫑", defaultUnit: "pack" },
  { name: "Celery", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 14, icon: "🥬", defaultUnit: "bunch" },
  { name: "Corn", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 3, icon: "🌽", defaultUnit: "ear" },
  { name: "Cabbage", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 14, icon: "🥬", defaultUnit: "head" },
  { name: "Kale", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 5, icon: "🥬", defaultUnit: "bunch" },
  { name: "Zucchini", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 7, icon: "🥒", defaultUnit: "pcs" },
  { name: "Squash", category: "vegetable", defaultStorage: "pantry", shelfLifeDays: 30, icon: "🎃", defaultUnit: "pcs" },
  { name: "Pumpkin", category: "vegetable", defaultStorage: "pantry", shelfLifeDays: 60, icon: "🎃", defaultUnit: "pcs" },
  { name: "Eggplant", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 5, icon: "🍆", defaultUnit: "pcs" },
  { name: "Mushrooms", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 5, icon: "🍄", defaultUnit: "pack" },
  { name: "Asparagus", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 3, icon: "🥦", defaultUnit: "bunch" },
  { name: "Green Beans", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 5, icon: "🥒", defaultUnit: "lb" },
  { name: "Peas", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 3, icon: "🫛", defaultUnit: "bag" },
  { name: "Cauliflower", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 7, icon: "🥦", defaultUnit: "head" },
  { name: "Brussels Sprouts", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 7, icon: "🥬", defaultUnit: "lb" },
  { name: "Artichoke", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 7, icon: "🥬", defaultUnit: "pcs" },
  { name: "Leek", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 10, icon: "🧅", defaultUnit: "bunch" },
  { name: "Radish", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 14, icon: "🥕", defaultUnit: "bunch" },
  { name: "Beet", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 14, icon: "🥕", defaultUnit: "bunch" },
  { name: "Beets", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 14, icon: "🥕", defaultUnit: "bunch" },
  { name: "Turnip", category: "vegetable", defaultStorage: "fridge", shelfLifeDays: 14, icon: "🥕", defaultUnit: "pcs" },
