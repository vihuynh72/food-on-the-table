...
-- This combines both notification and chat system migrations
-- =====================================================
...
-- RLS Policies for notification_preferences (drop existing first to avoid conflicts)
...
-- 10. Function to get or create conversation for an interest
...
-- 12. Function to mark conversation as read
...
-- 13. Function to soft-delete a message
...
-- 14. Function to mute/unmute conversation
...
-- 15. Function to get total unread message count
...
-- 16. Migrate existing interest_messages to new system (if table exists)
DO $$
BEGIN
...
-- 17. Enable Realtime for chat tables (ignore errors if already added)
DO $$
BEGIN
